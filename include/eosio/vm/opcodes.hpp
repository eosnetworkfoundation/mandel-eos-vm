...
namespace eosio { namespace vm {
   ...
   using opcode = variant<
      ...
      EOS_VM_VEC_LANE_MEMORY_OPS(EOS_VM_IDENTITY)
      EOS_VM_VEC_CONSTANT_OPS(EOS_VM_IDENTITY)
      EOS_VM_VEC_SHUFFLE_OPS(EOS_VM_IDENTITY)
      EOS_VM_VEC_LANE_OPS(EOS_VM_IDENTITY)
      EOS_VM_VEC_NUMERIC_OPS(EOS_VM_IDENTITY)
